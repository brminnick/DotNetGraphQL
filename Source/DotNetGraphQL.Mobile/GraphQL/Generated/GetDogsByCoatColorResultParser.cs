...
namespace DotNetGraphQL.Mobile
{
    ...
    public class GetDogsByCoatColorResultParser
        : JsonResultParserBase<IGetDogsByCoatColor>
    {
        private readonly IValueSerializer _stringSerializer;
        private readonly IValueSerializer _dateTimeSerializer;

        public GetDogsByCoatColorResultParser(IValueSerializerCollection serializerResolver)
        {
        ...
        protected override IGetDogsByCoatColor ParserData(JsonElement data)
        {
            return new GetDogsByCoatColor
            (
                ParseGetDogsByCoatColorDogs(data, "dogs")
            );

        }

        private IReadOnlyList<IDogImage> ParseGetDogsByCoatColorDogs(
            JsonElement parent,
            string field)
        {

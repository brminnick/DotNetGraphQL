...
namespace DotNetGraphQL.Mobile
{
    ...
    public static class DogsClientServiceCollectionExtensions
    {
        ...
        public static IOperationClientBuilder AddDogsClient(
            this IServiceCollection serviceCollection)
        {
            ...
            serviceCollection.AddSingleton<IDogsClient, DogsClient>();
            ...
            IOperationClientBuilder builder = serviceCollection.AddOperationClientOptions(_clientName)
                .AddResultParser(serializers => new GetAllDogsResultParser(serializers))
                .AddResultParser(serializers => new GetDogsByCoatColorResultParser(serializers))
